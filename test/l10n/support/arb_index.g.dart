...
const Map<String, Map<String, String>> kArbStrings = {
  ...
  'ta': {
    ...
    'signInCaption': 'தெய்வீகம் இல்லத்திற்கு வரட்டும்',
    ...
    'ringtoneVolumeMuted': 'இந்த முன்னோட்டத்தைக் கேட்க ஒலியை அதிகரிக்கவும்',
    'ringtoneCurrentBadge': 'தற்போதையது',
  ...
  'kn': {
    ...
    'signInCaption': 'ದೈವಿಕತೆ ಮನೆಗೆ ಬರಲಿ',
    ...
    'ringtoneSetApplying': 'ರಿಂಗ್‌ಟೋನ್ ಸೆಟ್ ಮಾಡಲಾಗುತ್ತಿದೆ…',
    'save': 'ಉಳಿಸಿ',
    'cancel': 'ರದ್ದು',
  ...
  'ml': {
    ...
    'signInCaption': 'ദൈവികത വീട്ടിലേക്ക് വരട്ടെ',
    ...
    'ringtoneVolumeMuted': 'ഈ പ്രിവ്യൂ കേൾക്കാൻ ശബ്ദം കൂട്ടുക',
    'ringtoneCurrentBadge': 'നിലവിലുള്ളത്',
    ...
    'settingsHelpDeleteSub': 'നിങ്ങളുടെ അക്കൗണ്ട് നീക്കുന്നു',
  ...
  'hi': {
    ...
    'ringtoneVolumeMuted': 'यह प्रीव्यू सुनने के लिए आव़ाज़ बढ़ाएँ',
    'ringtoneCurrentBadge': 'मौजूदा',
    ...
    'settingsPremiumSubCancelled': 'ऑटो-रिन्यू बंद · ऐक्सेस जारी है',
    ...
    'settingsHelpDeleteSub': 'आपका अकाउंट हट जाता है',
    ...
    'referStep2': 'वे Arul इंस्टॉल करके प्रीमियम सब्सक्राइब करते हैं',

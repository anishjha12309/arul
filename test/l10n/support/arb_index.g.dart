...
const Map<String, Map<String, String>> kArbStrings = {
  ...
  'ta': {
    ...
    'wallpaperShareCaption':
        'இது போன்ற இன்னும் நிறைய பக்தி வால்பேப்பர்கள் — படமாகவும் லைவ்வாகவும் — Arul-இல்:\n{link}',
    'referShareMessage':
    ...
    'settingsRemindersSubOn': 'வார & பண்டிகை நினைவூட்டல்கள் ஆன்',
    'settingsRemindersSubOff': 'பண்டிகை & வார நினைவூட்டல்கள்',
    ...
    'remindersTitle': 'நினைவூட்டல்',
    'remindersToggleTitle': 'பக்தி நினைவூட்டல்கள்',
    'remindersToggleSub': 'வாரம் ஒரு நாள், எல்லா முக்கிய பண்டிகைகளும்',
    'remindersScheduleNote':
    ...
    'premiumTrialFinePrint':
        'பிறகு ஆட்டோபே மூலம் மாதம் {price}. எப்போது வேண்டுமானாலும் ரத்து செய்யலாம்.',
    'premiumPaidFinePrint':
        'மாதம் {price}, ஆட்டோபே மூலம். எப்போது வேண்டுமானாலும் ரத்து செய்யலாம்.',
  ...
  'te': {
    ...
    'wallpaperShareCaption':
        'ఇలాంటి మరిన్ని భక్తి వాల్‌పేపర్లు — ఫోటో, లైవ్ — Arulలో:\n{link}',
    'referShareMessage':
        'దక్షిణ భారత భక్తి వాల్‌పేపర్ల కోసం నేను Arul వాడుతున్నా — అమ్మవారు, మురుగన్, వెంకటేశ్వర స్వామి, శివుడు, కదిలే లైవ్ వాల్‌పేపర్లు కూడా ఉన్నాయి. మీకూ నచ్చుతుందనుకున్నా.\n\n{link}',
    ...
    'remindersTitle': 'రిమైండర్లు',
    'remindersToggleTitle': 'భక్తి రిమైండర్లు',
    'remindersToggleSub': 'ప్రతి శుక్రవారం, ప్రతి పెద్ద పండుగ',
    'remindersScheduleNote':
  ...
  'kn': {
    ...
    'wallpaperShareCaption':
        'ಇಂತಹ ಇನ್ನಷ್ಟು ಭಕ್ತಿ ವಾಲ್‌ಪೇಪರ್‌ಗಳು — ಫೋಟೋ ಮತ್ತು ಲೈವ್ — Arul ನಲ್ಲಿ:\n{link}',
    'referShareMessage':
        'ದಕ್ಷಿಣ ಭಾರತೀಯ ಭಕ್ತಿ ವಾಲ್‌ಪೇಪರ್‌ಗಳಿಗಾಗಿ ನಾನು Arul ಬಳಸುತ್ತಿದ್ದೇನೆ — ಅಮ್ಮನ್, ಮುರುಗನ್, ಪೆರುಮಾಳ್, ಶಿವ, ಮತ್ತು ನಿಜವಾಗಿ ಚಲಿಸುವ ಲೈವ್ ವಾಲ್‌ಪೇಪರ್‌ಗಳೂ ಇವೆ. ನಿಮಗೂ ಇಷ್ಟವಾಗಬಹುದು ಅನಿಸಿತು.\n\n{link}',
    ...
    'remindersTitle': 'ರಿಮೈಂಡರ್‌ಗಳು',
    'remindersToggleTitle': 'ಭಕ್ತಿ ರಿಮೈಂಡರ್‌ಗಳು',
    'remindersToggleSub': 'ವಾರಕ್ಕೊಮ್ಮೆ, ಮತ್ತು ಪ್ರತಿ ದೊಡ್ಡ ಹಬ್ಬಕ್ಕೆ',
    'remindersScheduleNote':
  ...
  'ml': {
    ...
    'wallpaperShareCaption':
        'ഇതുപോലെ കൂടുതൽ ഭക്തി വാൾപേപ്പറുകൾ — ഫോട്ടോയും ലൈവും — Arul ആപ്പിൽ:\n{link}',
    'referShareMessage':
    ...
    'settingsRemindersSubOn': 'ആഴ്ച, ഉത്സവ റിമൈൻഡറുകൾ ഓണാണ്',
    'settingsRemindersSubOff': 'ഉത്സവ, ആഴ്ച റിമൈൻഡറുകൾ',
    ...
    'remindersTitle': 'റിമൈൻഡറുകൾ',
    'remindersToggleTitle': 'ഭക്തി റിമൈൻഡറുകൾ',
    'remindersToggleSub': 'ആഴ്ചയിൽ ഒരു ദിവസവും എല്ലാ പ്രധാന ഉത്സവത്തിനും',
    'remindersScheduleNote':
    ...
    'premiumPaidFinePrint':
        'മാസം {price}, ഓട്ടോപേ വഴി. എപ്പോൾ വേണമെങ്കിലും റദ്ദാക്കാം.',
  ...
  'hi': {
    ...
    'wallpaperShareCaption':
        'ऐसे और भक्ति वॉलपेपर — फ़ोटो और लाइव — Arul पर:\n{link}',
    'referShareMessage':
    ...
    'settingsRemindersSubOn': 'हर हफ़्ते और त्योहार के रिमाइंडर चालू',
    'settingsRemindersSubOff': 'त्योहार और हर हफ़्ते के रिमाइंडर',
    ...
    'remindersToggleSub': 'हर हफ़्ते का ख़ास दिन, और हर बड़ा त्योहार',
    'remindersScheduleNote':

...
const Map<String, Map<String, String>> kArbStrings = {
  'en': {
    ...
    'settingsHelpDeleteSub': 'Remove your account for good',
  ...
  'ta': {
    ...
    'settingsHelpSupportSub': 'மின்னஞ்சலில் எங்களுக்கு எழுதுங்கள்',
    'settingsHelpManage': 'சந்தாவை நிர்வகிக்கவும்',
    'settingsHelpDeleteSub': 'உங்கள் கணக்கை நிரந்தரமாக நீக்கும்',
  ...
  'te': {
    ...
    'settingsNeedHelpSub': 'సపోర్ట్ మరియు సబ్‌స్క్రిప్షన్',
    'settingsHelpSupport': 'సపోర్ట్‌ను సంప్రదించండి',
    'settingsHelpSupportSub': 'ఇమెయిల్‌లో మాకు రాయండి',
    'settingsHelpManage': 'సబ్‌స్క్రిప్షన్ నిర్వహించండి',
    'settingsHelpDeleteSub': 'మీ ఖాతాను శాశ్వతంగా తొలగిస్తుంది',
  ...
  'kn': {
    ...
    'settingsHelpSupport': 'ಬೆಂಬಲವನ್ನು ಸಂಪರ್ಕಿಸಿ',
    'settingsHelpSupportSub': 'ಇಮೇಲ್‌ನಲ್ಲಿ ನಮಗೆ ಬರೆಯಿರಿ',
    'settingsHelpManage': 'ಚಂದಾದಾರಿಕೆ ನಿರ್ವಹಿಸಿ',
    'settingsHelpDeleteSub': 'ನಿಮ್ಮ ಖಾತೆಯನ್ನು ಶಾಶ್ವತವಾಗಿ ಅಳಿಸುತ್ತದೆ',
  ...
  'ml': {
    ...
    'settingsHelpDeleteSub': 'നിങ്ങളുടെ അക്കൗണ്ട് എന്നന്നേക്കുമായി നീക്കും',
  ...
  'hi': {
    ...
    'settingsNeedHelpSub': 'सपोर्ट और सदस्यता',
    'settingsHelpSupport': 'सपोर्ट से संपर्क करें',
    'settingsHelpSupportSub': 'ईमेल से हमें लिखें',
    'settingsHelpManage': 'सदस्यता प्रबंधित करें',
    'settingsHelpDeleteSub': 'आपका खाता हमेशा के लिए हट जाएगा',
